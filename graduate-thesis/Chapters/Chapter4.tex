...
\begin{center}
    \includegraphics[width=\textwidth]{MSFT-Boosted-Decision-Trees-In-Sample-Prediction.png}
    \captionof{figure}{MSFT Boosted Decision Trees in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-MSFT-Boosted-Decision-Trees-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{CDE-Boosted-Decision-Trees-In-Sample-Prediction.png}
    \captionof{figure}{CDE Boosted Decision Trees in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-CDE-Boosted-Decision-Trees-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{NAVB-Boosted-Decision-Trees-In-Sample-Prediction.png}
    \captionof{figure}{NAVB Boosted Decision Trees in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-NAVB-Boosted-Decision-Trees-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{HRG-Boosted-Decision-Trees-In-Sample-Prediction.png}
    \captionof{figure}{HRG Boosted Decision Trees in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-HRG-Boosted-Decision-Trees-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{HL-Boosted-Decision-Trees-In-Sample-Prediction.png}
    \captionof{figure}{HL Boosted Decision Trees in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-HL-Boosted-Decision-Trees-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{MSFT-NUTS-In-Sample-Prediction.png}
    \captionof{figure}{MSFT NUTS in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-MSFT-NUTS-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{NAVB-NUTS-In-Sample-Prediction.png}
    \captionof{figure}{NAVB NUTS in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-NAVB-NUTS-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{HRG-NUTS-In-Sample-Prediction.png}
    \captionof{figure}{HRG NUTS in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-HRG-NUTS-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{HL-NUTS-In-Sample-Prediction.png}
    \captionof{figure}{HL NUTS in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-HL-NUTS-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{MSFT-Metropolis-In-Sample-Prediction.png}
    \captionof{figure}{MSFT Metropolis-Hastimgs in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-MSFT-Metropolis-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{CDE-Metropolis-In-Sample-Prediction.png}
    \captionof{figure}{CDE Metropolis-Hastimgs in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-CDE-Metropolis-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{NAVB-Metropolis-In-Sample-Prediction.png}
    \captionof{figure}{NAVB Metropolis-Hastimgs in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-NAVB-Metropolis-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{HRG-Metropolis-In-Sample-Prediction.png}
    \captionof{figure}{HRG Metropolis-Hastimgs in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-HRG-Metropolis-Out-of-Sample-Forecast.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{HL-Metropolis-In-Sample-Prediction.png}
    \captionof{figure}{HL Metropolis-Hastimgs in-sample prediction}
    \label{fig:nonfloat}
\end{center}

\begin{center}  
    \includegraphics[width=\textwidth]{100-Day-HL-Metropolis-Out-of-Sample-Forecast.png}
...
\begin{center}  
    \includegraphics[width=\textwidth]{MLC-Portfolio-Benchmark.png}
    \captionof{figure}{Machine Learning Classifier Strategy}
    \label{fig:nonfloat}
\end{center}
...
\begin{center}  
    ...
    \captionof{figure}{Machine Learning Regression Strategy}
    \label{fig:nonfloat}
\end{center}