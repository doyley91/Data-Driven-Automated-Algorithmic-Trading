...
def main(tickers=['AAPL'], start=None, end=None, n_steps=21):
    ...
    for ticker in tickers:
        ...
        fig.tight_layout()
        fig.savefig('charts/{}-Random-Forest-In-Sample-Prediction.png'.format(ticker))
        ...
        ax.legend(['Forecast $'])
        fig.tight_layout()
        fig.savefig('charts/{}-Day-{}-Random-Forest-Out-of-Sample-Forecast.png'.format(n_steps, ticker))
