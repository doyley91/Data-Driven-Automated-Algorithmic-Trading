...
def main(tickers=['AAPL'], start=None, end=None, n_steps=21):
    ...
    for ticker in tickers:
        ...
        fig.tight_layout()
        fig.savefig('charts/{}-K-Nearest-Neighbour-In-Sample-Prediction.png'.format(ticker))
        ...
        ax.legend(['Forecast $'])
        fig.tight_layout()
        fig.savefig('charts/{}-Day-{}-K-Nearest-Neighbour-Out-Of-Sample-Forecast.png'.format(n_steps, ticker))
